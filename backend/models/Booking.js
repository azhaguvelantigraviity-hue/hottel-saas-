...
const BookingSchema = new mongoose.Schema({
  ...
  petType:       String,
  petSize:       String,
  petManualRate: { type: Number, default: 0 },
  petDiscountType:{ type: String, enum: ['none', 'low_budget', 'manual_discount', 'free'], default: 'none' },
  petManualDiscountAmount: { type: Number, default: 0 },
