...
const seed = async () => {
  ...
  const hotelDefs = [
    // STARTER
    { name: 'Hilltop Heritage Inn', city: 'Shimla',    plan: 'starter',       rooms: 22,  email: 'info@hilltopinn.com' },
    { name: 'Desert Bloom Hotel',   city: 'Jaipur',    plan: 'starter',       rooms: 18,  email: 'info@desertbloom.com' },
    // PROFESSIONAL
    { name: 'Azure Boutique Hotel', city: 'Goa',       plan: 'professional',  rooms: 68,  email: 'ops@azuregoa.com' },
    { name: 'Metro Stay Bangalore', city: 'Bangalore',  plan: 'professional',  rooms: 95,  email: 'stay@metrobng.com' },
    // ENTERPRISE
    { name: 'The Grand Meridian',   city: 'Mumbai',    plan: 'enterprise',    rooms: 240, email: 'gm@grandmeridian.com' },
    { name: 'Skyline Suites Delhi', city: 'Delhi',     plan: 'enterprise',    rooms: 310, email: 'ceo@skylinesuites.com' },
  ];
