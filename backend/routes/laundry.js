...
router.post('/', requireFeature('laundry'), authorize('hotel_admin', 'platform_admin'), createOrder);
router.put('/:id', requireFeature('laundry'), authorize('hotel_admin', 'platform_admin'), updateOrder);
router.patch('/:id/advance', requireFeature('laundry'), authorize('hotel_admin', 'platform_admin'), advanceOrder);
