...
const AdminApp = ({ onLogout }) => {
  ...
  const titles = {
    ...
    subscriptions: 'Subscriptions & Payments', revenue: 'Revenue Management', analytics: 'Analytics Dashboard', alerts: 'Trial & Renewal Alerts',
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      <div style={{ background: 'var(--card)', padding: '48px 40px', borderRadius: '16px', border: '1px solid var(--border)', textAlign: 'center', maxWidth: '460px', boxShadow: '0 20px 40px rgba(0,0,0,0.2)' }}>
        ...
        <p style={{ color: 'var(--text2)', fontSize: '15px', lineHeight: 1.6, marginBottom: '32px' }}>
          Your 24-hour free trial of StayOS has expired. Please upgrade your plan or contact the platform administrator to continue managing your property seamlessly.
        </p>
