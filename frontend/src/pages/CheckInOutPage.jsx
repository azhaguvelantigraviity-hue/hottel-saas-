                    ...
                    <td style={{ padding: '16px', textAlign: 'right' }}>
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '16px' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                          <button title="View Booking" onClick={() => window.location.href='/hotel/bookings'} style={{ background: '#fff', border: '1px solid #e2e8f0', cursor: 'pointer', color: '#475569', padding: '8px', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' }} onMouseEnter={e=>{e.currentTarget.style.background='#f8fafc'; e.currentTarget.style.borderColor='#cbd5e1'}} onMouseLeave={e=>{e.currentTarget.style.background='#fff'; e.currentTarget.style.borderColor='#e2e8f0'}}><Icon name="eye" size={16} /></button>
                          <button title="Edit Booking" onClick={() => window.location.href='/hotel/bookings'} style={{ background: '#fff', border: '1px solid #e2e8f0', cursor: 'pointer', color: '#475569', padding: '8px', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' }} onMouseEnter={e=>{e.currentTarget.style.background='#f8fafc'; e.currentTarget.style.borderColor='#cbd5e1'}} onMouseLeave={e=>{e.currentTarget.style.background='#fff'; e.currentTarget.style.borderColor='#e2e8f0'}}><Icon name="edit" size={16} /></button>
                        </div>
                        {activeTab === 'arrivals' ? (
                          b.status === 'checked_in' ? (
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
